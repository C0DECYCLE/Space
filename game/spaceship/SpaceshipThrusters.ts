...
class SpaceshipThrusters implements ISpaceshipThrusters {
    ...
    private setupThruster(): BABYLON.GPUParticleSystem {
        ...
        const thruster: BABYLON.GPUParticleSystem = new BABYLON.GPUParticleSystem( `particles_thruster_${ this.spaceship.root.name }`, { capacity: 400 }, this.spaceship.game.scene );
