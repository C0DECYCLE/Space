...
class Manager {
    ...
    #create() {
        ...
        this.scene = new BABYLON.Scene( Space.engine.babylon );
                ...
                this.scene.enablePhysics( BABYLON.Vector3.Zero(), physicsPlugin );
        ...
        this.planets.register( planet );
                ...
                */
                ...
                ////////////////////////////////////////////////////
                let entity = new Entity( "dummy", this.scene, this.camera );
                
                let mesh = BABYLON.MeshBuilder.CreateBox( "dummy_mesh", { width: 1, height: 1.5, depth: 0.5 }, this.scene );
                mesh.convertToFlatShadedMesh();
                mesh.parent = entity;

                entity.enableOriginPhysics( mesh, BABYLON.PhysicsImpostor.BoxImpostor, { mass: 1, friction: 1, restitution: 0.5 } );

                entity.originPosition.copyFromFloats( 2, 500, 2050 );

                setTimeout( () => {

                    let forceDirection = planet.entity.position.subtract( entity.position ).normalize();
                    let forceMagnitude = 5;
                    let contactPoint = entity.position;
                    log(entity.physicsImpostor)
                    entity.physicsImpostor.applyForce( forceDirection.scale( forceMagnitude ), contactPoint );
