...
class Manager {
    ...
    #create() {
        ...
        this.physics = new Physics( { fixedFps: 60 } );

        this.controls = new Controls( this.scene, {} );

        this.camera = new Camera( this.scene, this.controls, {} );

        this.player = new Player( this.scene, {}, this.camera, this.controls, this.physics );
    ...
    #stage() {
        ...
        this.player.entity.originManualUpdate = true;
