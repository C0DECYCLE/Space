...
class Manager {
    ...
    #create() {
        ...
        let planet = new Planet( this.scene, { key: 0, radius: 1024 }, new BABYLON.Vector3( -1123, 7237, -3943 ) );
    ...
    #stage() {
        ...
        this.planets.list.get( 0 ).root.position.copyFromFloats( 100, 100, 2048 * 2 );
        ...
        this.camera.attachToPlayer( this.player );
                ...
                window.gravitationalFieldEvent = physicsHelper.gravitationalField(
                    this.planets.list.get( 0 ).root.position.clone(),
                    {
                        radius: this.planets.list.get( 0 ).config.radius * 2,
                        strength: 1,
                        falloff: BABYLON.PhysicsRadialImpulseFalloff.Linear,
                    }
                );
                gravitationalFieldEvent.enable();
                var eventData = gravitationalFieldEvent.getData();
    ...
    update( delta ) {
        ...
        if ( this.config.freeze == false ) {
            ...
            this.planets.update();
                ...
                ////////////////////////////////////////////////////
                if ( orbit == true ) {
                    this.planets.list.get( 0 ).root.rotate( BABYLON.Axis.Y, -0.001, BABYLON.Space.LOCAL );
                    o += 0.001;
