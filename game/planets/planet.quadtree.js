...
class PlanetQuadtree {
    ...
    #getDistanceDot( params, position ) {
        ...
        let terrainifyOriginRotatePosition = BABYLON.Vector3.TransformCoordinates( terrainifyPosition, this.#planet.entity.computeOriginMatrix() );
        
        return {

            distance: BABYLON.Vector3.Distance( terrainifyOriginRotatePosition, params.insertOriginPosition ),

            dot: BABYLON.Vector3.Dot( params.centerToInsertion, terrainifyOriginRotatePosition.subtract( this.#planet.entity.originPosition ).normalize() )
        };
    }
