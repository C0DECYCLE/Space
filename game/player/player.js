...
class Player {
    ...
    constructor( scene, config, camera, controls ) {
        ...
        this.#createMesh();
                ...
                this.entity.enableOriginPhysics( this.mesh, BABYLON.PhysicsImpostor.BoxImpostor, { mass: 1, friction: 1, restitution: 0.5 } );
    ...
    #onPlanetEnter( oldState, planet ) {
        ...
        this.#planet = planet;
                ...
                /*
                let forceDirection = this.#planet.entity.position.subtract( this.entity.position ).normalize();
                let forceMagnitude = 50;
                let contactPoint = this.entity.position;
                log(forceDirection.scale( forceMagnitude ))
                this.entity.physicsImpostor.applyForce( forceDirection.scale( forceMagnitude ), contactPoint );
                */
